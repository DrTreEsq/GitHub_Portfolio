...
<h4>
  Scraping data from a US Constitution Website using scrapy and xpath. saved as json files. Using Azure PostgreSQL for deploying and automation (in progress📍)
</h4>
