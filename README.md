...
<h6 align='center'>current duties: STEM Teacher (during  day☀️), Grad Student (at night🌙), and entrepreneur (rest of the time⌛️) More information coming soon (will be hiring soon, stay tuned). </h6>
...
<h4 align="center">
Preparing to pursue/commence MD (Clinical Genetics/Genetic Programming), PhD (Computational Neuroscience) dual degree program after completing JD and commencing company launch
</h4>
