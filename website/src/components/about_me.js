...
export default function Aboutme() {
  return (
      <div>
        ...
        <h3 className="black"> Welcome, Earthling! My name is Tre and I am an Educcator, Lifelong Learner, and Interdisciplinery Researcher with a goal of learning each valuable skill necessary to pioneer the change that I wish to see in the world.
