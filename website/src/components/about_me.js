...
export default function Aboutme() {
  return (
      <div>
        ...
        <h3 className="black">Welcome, Earthling! My name is Tre and I am an Educator and Lifelong Learner with a goal of learning each valuable skill necessary to pioneer the change that I wish to see in the world.
