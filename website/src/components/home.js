export default function Home() {
  return (
      <div>
        ...
        <h3> Click here for the inside scoop! </h3>
        <a href="https://github.com/DrTreEsq?tab=repositories"> <img className="robot" src="https://i.postimg.cc/kGmTbr5M/IMG-0551.jpg" alt="robot"></img> </a>
